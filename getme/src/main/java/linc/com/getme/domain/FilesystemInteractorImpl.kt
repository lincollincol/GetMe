...
internal class FilesystemInteractorImpl(
     ...
     * */
    override fun execute(): Single<List<FilesystemEntity>> {
     ...
     * */
    override fun openFilesystemEntity(filesystemEntity: FilesystemEntity): Single<List<FilesystemEntity>> {
        return Single.create {
     ...
     * */
    override fun openPreviousFilesystemEntity(): Single<List<FilesystemEntity>> {
        return Single.create {
            try {
     ...
     * */
    override fun prepareResultFiles(filesystemEntities: List<FilesystemEntity>): Single<List<File>> {
        return Single.create {
     ...
     * @return path to selected directory(-ies)
     * */
    override fun prepareResultDirectory(): Single<List<File>> {
     ...
     * */
    override fun restoreState(): Single<List<FilesystemEntity>> {
        return Single.create {
    ...
    /**
     * External app functions dependencies
     * */

    /**
     * @return current state
     * @example /storage/0000-0000/directory
     * */
    override fun retrieveState() = stateManager.getLast()
